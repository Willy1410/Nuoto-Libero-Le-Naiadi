...
<head>
    ...
    <meta name="twitter:image" content="assets/brand/squalo_nuoto_colore.jpg">
        ...
        <div class="container">
            ...
            <div class="advantages-grid">
                <div class="advantage-card">
                    ...
                    <p>Corsie riservate al nuoto libero con divisione per velocit&agrave;. Massimo comfort durante l'allenamento.</p>
                </div>
                ...
                <div class="advantage-card">
                    ...
                    <p>Struttura pulita e costantemente controllata. Acqua trattata secondo le normative pi&ugrave; rigide.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="faq-container">
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>S&igrave;, &egrave; obbligatorio presentare un certificato medico di idoneit&agrave; sportiva non agonistica in corso di validit&agrave;. Puoi scaricarlo dalla sezione <a href="moduli.php">Moduli</a>.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <button class="faq-question">
                        <span>Quanto dura la validit&agrave; dei pacchetti?</span>
                        <i class="fas fa-chevron-down"></i>
                    </button>
                    <div class="faq-answer">
                        <p>I pacchetti da 10 e 20 ingressi hanno validit&agrave; di 6 mesi dalla data di attivazione. Il mensile dura 30 giorni dalla prima entrata.</p>
                    </div>
                </div>
            </div>
