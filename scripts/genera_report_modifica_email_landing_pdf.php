...
$sourcePath = $root . '/DOCUMENTAZIONE_E_CONFIG/REPORT_MODIFICA_EMAIL_LANDING.md';
$outputPath = $root . '/DOCUMENTAZIONE_E_CONFIG/REPORT_MODIFICA_EMAIL_LANDING.pdf';
...
$pdf->SetAuthor('Codex');
$pdf->SetTitle('Report Modifica Email Landing');
$pdf->SetSubject('Fix Reply-To cliente su form landing');
...
$pdf->Cell(0, 7, 'Nuoto Libero Le Naiadi - Report Modifica Email Landing', 0, 1, 'L');
