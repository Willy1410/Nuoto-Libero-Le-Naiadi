...
<head>
    ...
    <meta name="description" content="Orari nuoto libero in piscina. Fasce disponibili, regolamento e info pratiche per nuoto non agonistico.">
    <meta name="keywords" content="orari nuoto libero, orari piscina, piscina non agonistica, piscina naiadi">
    <meta name="robots" content="index,follow">
    <link rel="canonical" href="/orari-tariffe.php">
    <meta property="og:type" content="website">
    <meta property="og:locale" content="it_IT">
    <meta property="og:title" content="Orari Nuoto Libero - Gli Squaletti">
    ...
    <title>Orari Nuoto Libero - Gli Squaletti</title>
...
<li><a href="moduli.php">Moduli</a></li>
    ...
    <section class="page-hero">
        <div class="container">
            <h1><i class="fas fa-clock"></i> Orari Nuoto Libero</h1>
            <p>Trova l'orario perfetto per il tuo allenamento in piscina</p>
        </div>
    </section>
    ...
    <section class="schedule-section">
        <div class="container">
            ...
            <p class="section-subtitle">LunedÃ¬, MercoledÃ¬ e VenerdÃ¬ presso Piscina Naiadi - Spoltore (PE)</p>
            ...
            <div class="schedule-table-container">
                <table class="schedule-table">
                    ...
                    <tbody>
                        <tr>
                            <td><strong>LunedÃ¬</strong></td>
                            <td>06:30 - 09:00</td>
                            <td>13:00 - 14:00</td>
                            <td>-</td>
                        </tr>
                        <tr class="weekend">
                            <td><strong>MartedÃ¬</strong></td>
                            <td colspan="3" style="text-align: center; color: var(--gray-500);">CHIUSO</td>
                        </tr>
                        <tr>
                            <td><strong>MercoledÃ¬</strong></td>
                            <td>06:30 - 09:00</td>
                            <td>13:00 - 14:00</td>
                            <td>-</td>
                        </tr>
                        <tr class="weekend">
                            <td><strong>GiovedÃ¬</strong></td>
                            <td colspan="3" style="text-align: center; color: var(--gray-500);">CHIUSO</td>
                        </tr>
                        <tr>
                            <td><strong>VenerdÃ¬</strong></td>
                            <td>06:30 - 09:00</td>
                            <td>13:00 - 14:00</td>
                            <td>-</td>
                        </tr>
            ...
            <div class="schedule-notes">
                ...
                <ul>
                    <li><i class="fas fa-check"></i> Le corsie sono divise per velocitÃ  (lenta, media, veloce)</li>
    ...
    <section class="rules-section">
        <div class="container">
            <h2 class="section-title">Regolamento Piscina</h2>
            <p class="section-subtitle">Per la sicurezza e il comfort di tutti</p>
            ...
            <div class="rules-grid">
                <div class="rule-card">
                    ...
                    <p>Ãˆ <strong>obbligatorio</strong> presentare un certificato medico di idoneitÃ  sportiva non agonistica in corso di validitÃ . Scarica il modulo dalla sezione <a href="moduli.php">Moduli</a>.</p>
                </div>
                ...
                <div class="rule-card">
                    ...
                    <p>L'uso della <strong>cuffia</strong> Ã¨ obbligatorio per tutti gli utenti, compresi coloro che hanno capelli corti o rasati. Disponibile in reception.</p>
                </div>
                ...
                <div class="rule-card">
                    ...
                    <p>Ãˆ <strong>obbligatorio</strong> fare la doccia prima di accedere in vasca. Aiutiamo a mantenere l'acqua pulita per tutti.</p>
                </div>
                ...
                <div class="rule-card">
                    ...
                    <h3>Costume Adeguato</h3>
                    <p>Sono ammessi solo <strong>costumi da piscina</strong> (no bermuda, shorts di cotone). I costumi devono essere puliti e in buono stato.</p>
                </div>
                ...
                <div class="rule-card">
                    ...
                    <h3>Bambini</h3>
                    <p>I minori di 14 anni devono essere <strong>accompagnati</strong> da un adulto responsabile che rimane nella struttura.</p>
                </div>
                ...
                <div class="rule-card">
                    ...
                    <h3>Comportamento</h3>
                    <p>Ãˆ vietato correre, tuffarsi, immergersi, giocare in modo pericoloso. Rispetta gli altri nuotatori e il personale.</p>
                </div>
            </div>

            <div class="cta-center">
                <a href="moduli.php" class="btn btn-primary">
                    <i class="fas fa-download"></i> Scarica il Regolamento Completo
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="cta-section">
        <div class="container">
            <div class="cta-box">
                <h2>Hai Trovato l'Orario Perfetto?</h2>
                <p>Richiedi iscrizione e inizia ad allenarti con il nuoto libero.</p>
                <a href="pacchetti.php" class="btn btn-primary btn-lg">
                    <i class="fas fa-shopping-cart"></i> Vai ai Pacchetti
                </a>
            </div>
        </div>
    </section>
