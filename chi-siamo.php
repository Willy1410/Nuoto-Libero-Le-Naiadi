...
<head>
    ...
    <meta name="description" content="Chi siamo: associazione sportiva dedicata al nuoto libero non agonistico, attivitÃ  in piscina coperta e 50 metri all'aperto in estate.">
...
<li><a href="moduli.php">Moduli</a></li>
    ...
    <section class="page-hero">
        <div class="container">
            <h1><i class="fas fa-users"></i> Chi Siamo</h1>
            <p>La passione per l'acqua, l'esperienza al tuo servizio</p>
        </div>
    </section>
        ...
        <div class="container">
            <div class="about-content">
                <div class="about-text">
                    <h2>CLADAM GROUP</h2>
                    <p class="lead">La SocietÃ  Sportiva <strong>CLADAM GROUP</strong>, proprietaria dei marchi <strong>"Le SqualOtte"</strong> e <strong>"Gli Squaletti"</strong>, Ã¨ altamente specializzata e con anni di esperienza nel settore, promuove e segue le attivitÃ  di acquaticitÃ  pre e post natale e nuoto libero.</p>
                    
                    <div class="mission-box">
                        <h3><i class="fas fa-bullseye"></i> La Nostra Missione</h3>
                        <p>Promuovere la cultura dell'acquaticitÃ  a tutte le etÃ , dall'infanzia all'etÃ  adulta, attraverso programmi personalizzati e strutture all'avanguardia.</p>
                    </div>
                </div>
    ...
    <section class="brands-section">
        <div class="container">
            <h2 class="section-title">I Nostri Marchi</h2>
            ...
            <div class="brands-grid">
                ...
                <div class="brand-card">
                    ...
                    <h3>Le SqualOtte</h3>
                    <p>Programmi di <strong>acquaticitÃ  pre e post natale</strong>. Corsi per gestanti, neonati e bambini in un ambiente sicuro e accogliente.</p>
    ...
    <section class="experience-section">
        <div class="container">
            <h2 class="section-title">Anni di Esperienza nel Settore</h2>
    ...
    <section class="facility-section">
        <div class="container">
            <h2 class="section-title">La Piscina Naiadi di Pescara</h2>
            <p class="section-subtitle">La nostra sede operativa per il nuoto libero</p>
            ...
            <div class="facility-content">
                ...
                <div class="facility-features">
                    <div class="feature-item">
                        ...
                        <div>
                            <h4>Piscina Olimpionica 50m</h4>
                            <p>10 corsie regolamentari, vasca all'aperto d'estate e coperta d'inverno</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div>
                            <h4>Estate & Inverno</h4>
                            <p>Struttura versatile: piscina scoperta nei mesi estivi, coperta durante l'inverno</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div>
                            <h4>Ampio Parcheggio</h4>
                            <p>Parcheggio gratuito disponibile per tutti gli utenti</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div>
                            <h4>Accessibile</h4>
                            <p>Struttura completamente accessibile a persone con disabilitÃ </p>
                        </div>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div>
                            <h4>Sicurezza</h4>
                            <p>Bagnini qualificati, acqua controllata, rispetto normative</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="values-grid">
                <div class="value-card">
                    ...
                    <h3>Passione</h3>
                    <p>Amiamo quello che facciamo e lo trasmettiamo ai nostri clienti</p>
                </div>

                <div class="value-card">
                    <i class="fas fa-star"></i>
                    <h3>ProfessionalitÃ </h3>
                ...
                <div class="value-card">
                    ...
                    <h3>Attenzione</h3>
                    <p>Ogni cliente Ã¨ importante e seguito personalmente</p>
                </div>
    ...
    <section class="cta-section">
        <div class="container">
            <div class="cta-box">
                <h2>Pronto a Tuffarti con Noi?</h2>
                <p>Unisciti alla famiglia CLADAM GROUP e scopri il piacere del nuoto</p>
                <div class="cta-buttons">
                    <a href="pacchetti.php" class="btn btn-primary btn-lg">
                        <i class="fas fa-ticket-alt"></i> Richiedi Iscrizione
                    </a>
                    <a href="contatti.php" class="btn btn-secondary btn-lg">
